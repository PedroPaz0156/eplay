    ...
    <>
      ...
      <Section title="Sobre o jogo" background="black">
        <p>
          ...
          poções, domine o lançamento de feitiços, aprimores talentos e torne-se
          o bruxo que deseja ser. Experimente Hogwarts Legacy da década de 1800.
          Seu personagem é um estudante com chave de um antigo segredo que
          ameaça destruir o mundo bruxo. Faça aliados, lute contra os bruxos das
          trevas e decida o destino do mundo bruxo. Seu legado é o que você faz
          dele. Viva o inesperado
        </p>
      </Section>
